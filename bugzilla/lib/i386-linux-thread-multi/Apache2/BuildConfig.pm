...
'MODPERL_AP_LIBS' => '',
'MODPERL_AR' => 'ar',
'MODPERL_ARCHLIBEXP' => '/usr/lib/perl5/5.8.8/i386-linux-thread-multi',
'MODPERL_CC' => 'gcc',
'MODPERL_CCCDLFLAGS' => '-fPIC',
'MODPERL_CCOPTS' => ' -D_REENTRANT -D_GNU_SOURCE -fno-strict-aliasing -pipe -Wdeclaration-after-statement -I/usr/local/include -I/usr/include/gdbm -I/usr/lib/perl5/5.8.8/i386-linux-thread-multi/CORE -DMOD_PERL -DMP_COMPAT_1X -DLINUX=2 -D_LARGEFILE64_SOURCE',
'MODPERL_CP' => 'cp',
...
'MODPERL_INC' => '-I/root/.cpan/build/mod_perl-2.0.8-A66xlC/src/modules/perl -I/root/.cpan/build/mod_perl-2.0.8-A66xlC/xs -I/usr/include/apr-1 -I/usr/include/apr-1  -I/usr/include/httpd',
'MODPERL_LD' => 'gcc',
'MODPERL_LDDLFLAGS' => '-shared -O2 -g -pipe -Wall -Wp,-D_FORTIFY_SOURCE=2 -fexceptions -fstack-protector --param=ssp-buffer-size=4 -m32 -march=i386 -mtune=generic -fasynchronous-unwind-tables -L/usr/local/lib',
'MODPERL_LDOPTS' => '-Wl,-E -Wl,-rpath,/usr/lib/perl5/5.8.8/i386-linux-thread-multi/CORE  -L/usr/local/lib /usr/lib/perl5/5.8.8/i386-linux-thread-multi/auto/DynaLoader/DynaLoader.a -L/usr/lib/perl5/5.8.8/i386-linux-thread-multi/CORE -lperl -lresolv -lnsl -ldl -lm -lcrypt -lutil -lpthread -lc',
'MODPERL_LIB' => 'mod_perl.so',
'MODPERL_LIBNAME' => 'mod_perl',
'MODPERL_LIBPERL' => '/usr/lib/perl5/5.8.8/i386-linux-thread-multi/CORE/libperl.so',
...
'MODPERL_MV' => 'mv',
'MODPERL_OBJ_EXT' => '.o',
'MODPERL_OPTIMIZE' => '-O2 -g -pipe -Wall -Wp,-D_FORTIFY_SOURCE=2 -fexceptions -fstack-protector --param=ssp-buffer-size=4 -m32 -march=i386 -mtune=generic -fasynchronous-unwind-tables',
...
'MODPERL_PRIVLIBEXP' => '/usr/lib/perl5/5.8.8',
'MODPERL_RANLIB' => ':',
'MODPERL_RM' => 'rm',
'MODPERL_RM_F' => 'rm -f',
'MODPERL_TEST_F' => 'test -f',
'MODPERL_XSUBPP' => '$(MODPERL_PERLPATH) $(MODPERL_PRIVLIBEXP)/ExtUtils/xsubpp -typemap $(MODPERL_PRIVLIBEXP)/ExtUtils/typemap -typemap /root/.cpan/build/mod_perl-2.0.8-A66xlC/lib/typemap',
'MP_APR_LIB' => 'aprext',
...
'cwd' => '/root/.cpan/build/mod_perl-2.0.8-A66xlC',
'dir' => undef,
